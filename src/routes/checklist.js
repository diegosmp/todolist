...
router.get('/:id/edit', async (req, res) => {
    try {
        ...
        res.status(500).render('pages/error', {error: 'Erro ao exibir a edição das listas de tarefas'})
    }
})
...
router.delete('/:id', async (req, res) => {
    try {
        ...
        res.status(500).render('pages/error', {error: 'Erro ao excluir a listas de tarefas'})
    }
})
